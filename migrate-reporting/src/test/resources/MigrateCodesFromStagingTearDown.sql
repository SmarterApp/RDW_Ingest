...
DELETE FROM staging_test.staging_translations WHERE content_code IN ('code1-test', 'code2-test') AND language_code in ('lan', 'gua') AND namespace = 'backend';
...
DELETE FROM reporting_test.translations WHERE content_code IN ('code1-test', 'code2-test', 'before_test_code') AND language_code in ('lan', 'gua', 'bef') AND namespace = 'backend';
