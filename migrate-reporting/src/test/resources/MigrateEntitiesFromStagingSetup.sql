-- ------------------------------------------ School/Districts --------------------------------------------------------------------------------------------------
INSERT INTO reporting_test.staging_district (id, name, natural_id, migrate_id) VALUES
  (-99, 'Sample District -99', 'natural_id-99', -99),
  (-98, 'Sample District -98', 'natural_id-98', -99);

INSERT INTO reporting_test.staging_school (id, district_id, name, natural_id, deleted, migrate_id, import_id, updated) VALUES
...
INSERT INTO reporting_test.staging_asmt (id, natural_id, grade_id, type_id, subject_id, school_year, name, label, version, deleted, migrate_id, import_id, updated) VALUES
...
INSERT INTO reporting_test.staging_asmt_score (asmt_id, cut_point_1, cut_point_2, cut_point_3, min_score, max_score, migrate_id) VALUES
  (-99, 2442, 2502, 2582, 2201, 2701, -99),
  (-98, 2442, 2502, 2582, 2201, 2701, -99);

INSERT INTO reporting_test.staging_item (id, claim_id, target_id, natural_id, asmt_id, dok_id, difficulty_code, max_points, math_practice, allow_calc, position, migrate_id) VALUES
...
INSERT INTO reporting_test.staging_item_other_target(item_id, target_id) values
 (-990, -98),
 (-990, -99),

 (-980, -98);

INSERT INTO reporting_test.staging_item_common_core_standard(item_id, common_core_standard_id) values
 (-990, -98),
 (-990, -99),
...
-- ------------------------------------------ Student and Groups  ------------------------------------------------------------------------------------------------
 ...
 INSERT INTO reporting_test.staging_student (id, ssid, last_or_surname, first_name, middle_name, gender_id, first_entry_into_us_school_at, lep_entry_at,
...
INSERT INTO reporting_test.staging_student_ethnicity(student_id, ethnicity_id) values
    (-89,  -99),
    (-88,  -98),
    (-87,  -98),
    (-86,  -98),
...
INSERT INTO reporting_test.staging_student_group (id, creator, created, school_id, school_year, name, subject_id, import_id, migrate_id, active, deleted, updated) VALUES
 ...
 INSERT INTO reporting_test.staging_student_group_membership (student_group_id, student_id) VALUES
   (-91, -89),
   (-91, -88),
   (-91, -87),
   (-91, -86),
 ...
 INSERT INTO reporting_test.staging_user_student_group (student_group_id, user_login) VALUES
...
-- ------------------------------------------  Exams ------------------------------------------------------------------------------------------------
INSERT INTO reporting_test.staging_exam_student ( id, grade_id, student_id, school_id, iep, lep, section504, economic_disadvantage,
...
INSERT INTO  reporting_test.staging_exam ( id, type_id,  exam_student_id, school_year, asmt_id, asmt_version, opportunity, completeness_id,
...
INSERT INTO reporting_test.staging_exam_available_accommodation (exam_id, accommodation_id) VALUES
    (-88, -98),
    (-88, -99),
    (-87, -98);

INSERT INTO reporting_test.staging_exam_item (id, exam_id, item_id, score, score_status, response, position, migrate_id) VALUES
...
INSERT INTO reporting_test.staging_exam_claim_score (id, exam_id, subject_claim_score_id, scale_score, scale_score_std_err, category) VALUES
   (-1, -88, 1, 2014, 0.19, 1);