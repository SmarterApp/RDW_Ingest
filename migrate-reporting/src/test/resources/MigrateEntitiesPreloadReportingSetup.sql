...
INSERT INTO reporting_test.school (id, district_id, name, natural_id, import_id, updated) VALUES
  (-1, -1, 'Before Test -1', 'natural_id-1', -5000, '2017-05-18 20:06:34.966000'),
  (-99, -99, 'Before Test -99', 'natural_id-99', -1, '2017-07-18 20:14:34.000000');
...
INSERT INTO reporting_test.student (id, ssid, last_or_surname, first_name, middle_name, gender_id, gender_code, first_entry_into_us_school_at, lep_entry_at,
   ...
   (-11, '11', 'TestName', 'FirstName2', 'MiddleName2', -98, 'before_test', '2012-08-14', '2012-11-13', null, '2000-01-01', -5000, '2017-05-18 20:06:34.966000'),
   (-89, '89', 'TestName', 'FirstName2', 'MiddleName2', -98, 'before_test', '2012-08-14', '2012-11-13', null, '2000-01-01', -5000, '2017-05-18 20:06:34.966000');

INSERT INTO reporting_test.student_ethnicity(student_id, ethnicity_id, ethnicity_code) values
    (-89,  -99, 'before test');

INSERT INTO reporting_test.student_group (id, creator, school_id, school_year, name, subject_id, import_id, created, updated) VALUES
   (-91, 'TestName', -1, 2017, 'Test Student Group 9', null, -5000, '2017-05-18 19:05:33.967000', '2017-05-18 20:06:34.966000');
