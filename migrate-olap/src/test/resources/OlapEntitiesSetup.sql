...
-- ------------------------------------------ Asmt ---------------------------------------------------------------------------------------------------------
INSERT INTO asmt (id, grade_id, grade_code, type_id, subject_id, subject_code, school_year, name, label, updated, update_import_id, migrate_id) VALUES
   (-11, -98, '98', 3, 1, 'Math', 1999, 'test-summative-1999-98', 'summative-grade-98', '2017-07-18 20:14:34.000000', -1, -1),
   (-99, -99, '99', 1, 2, 'ELA', 1999, 'test', 'test', '2017-07-18 20:14:34.000000', -1, -1);
