...
INSERT INTO school (id, district_id, name, import_id, migrate_id) VALUES
  (-1, -1, 'Before Test -1', -1, -1),
  (-99, -99,'Before Test -99', -1, -1);

-- ------------------------------------------ Asmt ---------------------------------------------------------------------------------------------------------
INSERT INTO ica_asmt (id, grade_id, subject_id, school_year, name, import_id, migrate_id) VALUES
   (-11, -98, 1, 1999, 'SBAC-IAB-FIXED-G4M-OA-MATH-4', -1, -1),
   (-99, -99, 1, 1999, 'test', -1, -1);

-- ------------------------------------------ Student and Groups  ------------------------------------------------------------------------------------------------
INSERT INTO student (id, gender_id, import_id, migrate_id) VALUES
   (-11, -99, -1, -1),
   (-89, -99, -1, -1);
