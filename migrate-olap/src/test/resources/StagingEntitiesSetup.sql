...
INSERT INTO staging_school (id, district_id, name, deleted, update_import_id, migrate_id) VALUES
  (-99, -99, 'Sample School -99', 0, -1, -99),
  (-98, -98, 'Sample School -98', 0, -1, -99);

-- ------------------------------------------ Asmt ---------------------------------------------------------------------------------------------------------

INSERT INTO staging_asmt (id,  grade_id, type_id, subject_id, school_year, name, deleted, update_import_id, migrate_id) VALUES
