...
INSERT INTO staging_school (id, district_id, name, deleted, import_id, migrate_id) VALUES
  (-99, -99, 'Sample School -99', 0, -1, -99),
  (-98, -98, 'Sample School -98', 0, -1, -99);

-- ------------------------------------------ Asmt ---------------------------------------------------------------------------------------------------------

INSERT INTO staging_asmt (id,  grade_id, type_id, subject_id, school_year, name, deleted, import_id, migrate_id) VALUES
   (-99, -99, 1, 1, 1999, 'SBAC-IAB-FIXED-G4M-OA-MATH-4', 0, -1, -99),
   (-98, -98, 1, 2, 1999, 'SBAC-ICA-FIXED-G5E-COMBINED-2017', 0, -1, -99);

-- ------------------------------------------ Student  ------------------------------------------------------------------------------------------------

INSERT INTO staging_student (id, ssid, last_or_surname, first_name, middle_name, gender_id, import_id, migrate_id, deleted) VALUES
...
INSERT INTO  staging_exam ( id, type_id, school_year, asmt_id,  completeness_id,
                            ...
                            migrant_status, import_id) VALUES
